<<<<<<< HEAD:multiple-ROIs-lane-detection/include/ids.hpp
#ifndef IDS_H
#define IDS_H
...
public:
    ...
    UINT PixelClock = 20;
    int pixelclock_slider = 20;
    double Exposure = 145.0;
    int exposure_slider = 145;
...
#endif
>>>>>>> IDS:multiple-ROIs-lane-detection/include/ids.h
